...
class TCPConnection {
  private:
    ...
    // fill TCPConnection::_segments_out from TCPSender::_segments_out, return whether send at least one segment
  ...
  public:
    ...
    bool LISTEN() const { return !_sender.SYN_SENT() && !_receiver.SYN_RCVD(); }
};
