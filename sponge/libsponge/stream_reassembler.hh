...
class StreamReassembler {
  private:
    ...
    // push unassembled bytes from data, first byte at index , range[begin,end)
    size_t push_unassembled_bytes(const std::string &data, Index index, Index begin, Index end);
  ...
  public:
    ...
    void push_substring(const std::string &data, const Index index, const bool eof);
    ...
    Index expect_index() const { return _expect_index; }
};
